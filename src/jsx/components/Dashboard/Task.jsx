								...
								<div className="modal-body">
									...
									<div className="add-contact-box">
										<div className="add-contact-content">
											...
											<div className="form-group mb-3">
												<label className="text-black font-w500">Deadline Date <strong className="text-danger">*</strong></label>
												<div className="contact-name">
													<input type="text" className="form-control" autocomplete="off"
											...
											<div className="form-group mb-3">
												<label className="text-black font-w500">Client <strong className="text-danger">*</strong></label>
											...
											<div className="form-group mb-3">
												<label className="text-black font-w500">Location <strong className="text-danger">*</strong></label>
												<div className="contact-occupation">
													<input type="text" autocomplete="off"
