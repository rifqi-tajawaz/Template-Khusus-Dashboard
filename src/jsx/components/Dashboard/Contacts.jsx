...
import user from './../../../assets/images/pic1.jpg';
...
import pic8 from './../../../assets/images/contacts/2.jpg';
import pic9 from './../../../assets/images/contacts/3.jpg';
import pic10 from './../../../assets/images/contacts/4.jpg';
import pic11 from './../../../assets/images/contacts/5.jpg';
								...
								<div className="card contact-bx item-content">
									...
									<div className="card-body user-profile">
										...
										<div className="media-body user-meta-info">
											...
											<ul>
												<li><Link to={"#"}><i className="fas fa-phone-alt" /></Link></li>
												<li><Link to={"#"}><i className="far fa-comment-alt" /></Link></li>
