                ...
                >
                  {({
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      >
                        <label className="text-label">Username <strong className="text-danger">*</strong></label>
                      ...
                      >
                        <label className="text-label">Password <strong className="text-danger">*</strong></label>
